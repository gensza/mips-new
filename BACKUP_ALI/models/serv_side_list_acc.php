...
class serv_side_list_acc extends CI_Model
{

      // start datatables
      var $table = 'noac'; //nama tabel dari database
      var $column_order = array(null, 'NOID', 'noac', 'nama', 'group', 'type', 'sbu'); //field yang ada di table user
      var $column_search = array('noac', 'nama', 'group', 'type', 'sbu'); //field yang diizin untuk pencarian 

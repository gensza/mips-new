...
//              //start : ========================== step 1 ===================
                ...
                $var_ttldbs = $k_sql_rev['TTLDB'];
                $var_ttlcrs = $k_sql_rev['TTLCR'];
...
//                }
    ...
    function get_coa_capital($thn,$bln){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `group`,
                        `type`
                 FROM noac WHERE `group` = 'Capital' $filters_null and `type` = 'D' ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_expenses($thn,$bln){
        ...
        $sql = "SELECT  saldo01c,
                 ...
                 //$filters_null AND SUBSTR(noac,1,2) = 70 
        ...
        /*$sql = "SELECT  saldo01c,
                        ...
                        `group`,
                        `type`
                 FROM noac WHERE `group` = 'Expenses' $filters_null and `type` = 'D' ORDER BY noac ASC";*/
        return $this->mips_gl->query($sql);
    ...
    function get_coa_other_expenses($thn,$bln){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `group`,
                        `type`
                 FROM noac WHERE `group` = 'Other Expenses' ORDER BY noac ASC";
    ...
    function get_coa_other_revenue($thn,$bln){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `group`,
                        `type`
                 FROM noac WHERE `group` = 'Other Revenue' ORDER BY noac ASC";
    ...
    function get_coa_revenue($thn,$bln){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `group`,
                        `type`
                 FROM noac WHERE `group` = 'Revenue' ORDER BY noac ASC";

...
class Gl_lap_model extends CI_Model{	
    ...
    function get_coa_assets_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Asset' and `level` <= '$level' $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_capital_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Capital' and `level` <= '$level' $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_expenses_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Expenses' and `level` <= '$level' $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_liability_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Liability' and `level` <= '$level' $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_other_expenses_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Other Expenses' and `level` <= '$level' AND noac NOT IN ('950000000000000','950500000000000','950600000000000','950800000000000','951000000000000') $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_other_revenue_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Other Revenue' and `level` <= '$level' AND noac IN ('901000000000000','900900000000000','900100000000000','900450000000000','900500000000000','900700000000000') $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_revenue_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Revenue' and `level` <= '$level' AND noac IN ('600101010000000','600101050000000','600101100000000') $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
...
OR saldo12c <> 0 OR saldo12d <> 0) ORDER BY noac ASC";
    ...
    function balanace_aset_lancar($level){
        ...
        $sql = "SELECT * FROM noac WHERE `group` = 'Asset' AND `level` = '$level' and noac <> '203500000000000' AND SUBSTR(noac,1,2) = '10' $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function balance_aset_tidak_lancar($level){
        ...
        //$sql = "SELECT * FROM noac WHERE `group` = 'Asset' AND `level` IN ('2','3') AND noac NOT IN ('203500000000000','203545000000000') AND general NOT IN ('202500000000000','202400000000000','209500000000000','209000000000000','100000000000000','101000000000000','102000000000000','102500000000000','103000000000000','100100000000000') $filters_null AND `type` = 'G' ORDER BY noac ASC";
    ...
    function get_pendapatan_sum($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `level` <= '$level' AND SUBSTR(noac,1,2) = '60' $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_running_account($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `group` = 'Expenses' AND `level` <= '$level' AND SUBSTR(noac,1,2) = '40' $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_harga_pokok_penjualan($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `group` = 'Expenses' AND `level` = '$level' AND SUBSTR(noac,1,2) IN ('70','75') $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_biaya_administrasi_umum($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `group` = 'Expenses' AND `level` <= '$level' AND SUBSTR(noac,1,2) = '80' $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_pendapatan_lainnya($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `group` = 'Other Revenue' AND `level` <= '$level' AND SUBSTR(noac,1,2) = '90' $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_biaya_lainnya($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `group` = 'Other Expenses' AND `level` <= '$level' AND SUBSTR(noac,1,2) = '95' $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);

<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#tabel_gl_coa').DataTable({
            ...
            "ajax": {
                url: base_url + 'gl/account_detail_master',
                type: 'POST',
                data: {
    ...
    <div class="span12">
        ...
        <div class="table-responsive">
            <table id="tabel_gl_coa" class="table table-hover table-striped table-responsive table-bordered" style="width: 100%">
                <thead>
                    <tr>
                        <th style="width: 5%">No Acct</th>
                        <th style="width: 5%">G. Account</th>
                        <th style="width: 2%">Level</th>
                        <th style="width: 2%">G / D</th>
                        <th style="width: 40%">Accounts Name</th>

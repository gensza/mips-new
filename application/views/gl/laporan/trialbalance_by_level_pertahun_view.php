...
<table width="100%" border="0" align="center" class="font-styles fontsok">
    <tr>
...
<div style="width: 100%;text-align: right;font-size: 10px" class="font-styles fontsok">
...
<td style="text-align: right;<?php echo $bolds;?>">
    <?php 
		...
		if($b['yeard']<>0){
			$angka = number_format($b['yeard'],0);
			$saldo_year_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo_yearsss    = $b['yearc']*-1;
			$saldo_year_ekuitas_x += $saldo_yearsss;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo_yearsss,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
    ...
    $saldooekuitas01c = $b['saldo01c'];
		...
		if {noac.level}=2  then
		   if {NOAC.noac}="504500000000000" then 0
		   ELSE
		   
			   (if {NOAC.group}="Expenses" or {NOAC.group}="Asset" or {NOAC.group}="Other Expenses"then
					{@01}
		...
		*/
		...
		if($saldooekuitas01d<>0){
			$angka = number_format($saldooekuitas01d,0);
			$saldo01_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo01_ekuitas    = $saldooekuitas01c*-1;
			$saldo01_ekuitas_x += $saldo01_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo01_ekuitas,0));
		}
		//IF {noac.saldo01d}<>0 THEN {noac.saldo01d} ELSE {noac.saldo01c}*-1
...
<td style="text-align: right;<?php echo $bolds;?>">
    ...
    $saldooekuitas02c = $b['saldo02c'];
		...
		if($saldooekuitas02d<>0){
			$angka = number_format($saldooekuitas02d,0);
			$saldo02_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo02_ekuitas    = $saldooekuitas02c*-1;
			$saldo02_ekuitas_x += $saldo02_ekuitas;
...
<td style="text-align: right;<?php echo $bolds;?>">
    ...
    $saldooekuitas03c = $b['saldo03c'];
		...
		if($saldooekuitas03d<>0){
			$angka = number_format($saldooekuitas03d,0);
			$saldo03_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo03_ekuitas    = $saldooekuitas03c*-1;
			$saldo03_ekuitas_x += $saldo03_ekuitas;
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas04d<>0){
			$angka = number_format($saldooekuitas04d,0);
			$saldo04_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo04_ekuitas    = $saldooekuitas04c*-1;
			$saldo04_ekuitas_x += $saldo04_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo04_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas05d<>0){
			$angka = number_format($saldooekuitas05d,0);
			$saldo05_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo05_ekuitas    = $saldooekuitas05c*-1;
			$saldo05_ekuitas_x += $saldo05_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo05_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas06d<>0){
			$angka = number_format($saldooekuitas06d,0);
			$saldo06_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo06_ekuitas    = $saldooekuitas06c*-1;
			$saldo06_ekuitas_x += $saldo06_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo06_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas07d<>0){
			$angka = number_format($saldooekuitas07d,0);
			$saldo07_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo07_ekuitas    = $saldooekuitas07c*-1;
			$saldo07_ekuitas_x += $saldo07_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo07_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas08d<>0){
			$angka = number_format($saldooekuitas08d,0);
			$saldo08_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo08_ekuitas    = $saldooekuitas08c*-1;
			$saldo08_ekuitas_x += $saldo08_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo08_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas09d<>0){
			$angka = number_format($saldooekuitas09d,0);
			$saldo09_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo09_ekuitas    = $saldooekuitas09c*-1;
			$saldo09_ekuitas_x += $saldo09_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo09_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
    ...
    $saldooekuitas10c = $b['saldo10c'];
		...
		if($saldooekuitas10d<>0){
			$angka = number_format($saldooekuitas10d,0);
			$saldo10_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo10_ekuitas    = $saldooekuitas10c*-1;
			$saldo10_ekuitas_x += $saldo10_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo10_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas11d<>0){
			$angka = number_format($saldooekuitas11d,0);
			$saldo11_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo11_ekuitas    = $saldooekuitas11c*-1;
			$saldo11_ekuitas_x += $saldo11_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo11_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
	...
	/*if($b['noac'] == $account_labarugi){
		...
		if($saldooekuitas12d<>0){
			$angka = number_format($saldooekuitas12d,0);
			$saldo12_ekuitas_x += $angka;
			echo $angka;
		}else{
			$saldo12_ekuitas    = $saldooekuitas12c*-1;
			$saldo12_ekuitas_x += $saldo12_ekuitas;
			echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($saldo12_ekuitas,0));
		}
...
<td style="text-align: right;<?php echo $bolds;?>">
    ...
    $saldooekuitas12c_xx = $b['saldo12c'];
		...
		if($saldooekuitas_yeard_xx<>0){
			...
			$saldo_year_ekuitas_v    = $saldooekuitas_yearc_xx*-1;
			$saldo_year_ekuitas_xx = $saldo_year_ekuitas_v;
		}
		
		if($saldooekuitas01d_xx<>0){
			$saldo01_ekuitas_xx = $saldooekuitas01d_xx;
		}else{
			$saldo01_ekuitas_v    = $saldooekuitas01c_xx*-1;
			$saldo01_ekuitas_xx = $saldo01_ekuitas_v;
		}
		
		if($saldooekuitas02d_xx<>0){
			$saldo02_ekuitas_xx = $saldooekuitas02d_xx;
		}else{
			$saldo02_ekuitas_v     = $saldooekuitas02c_xx*-1;
			$saldo02_ekuitas_xx = $saldo02_ekuitas_v;
		}
		
		if($saldooekuitas03d_xx<>0){
			$saldo03_ekuitas_xx = $saldooekuitas03d_xx;
		}else{
			$saldo03_ekuitas_v     = $saldooekuitas03c_xx*-1;
			$saldo03_ekuitas_xx = $saldo03_ekuitas_v;
		}
		
		if($saldooekuitas04d_xx<>0){
			$saldo04_ekuitas_xx = $saldooekuitas04d_xx;
		}else{
			$saldo04_ekuitas_v     = $saldooekuitas04c_xx*-1;
			$saldo04_ekuitas_xx = $saldo04_ekuitas_v;
		}
		
		if($saldooekuitas05d_xx<>0){
			$saldo05_ekuitas_xx = $saldooekuitas05d_xx;
		}else{
			$saldo05_ekuitas_v     = $saldooekuitas05c_xx*-1;
			$saldo05_ekuitas_xx = $saldo05_ekuitas_v;
		}
		
		if($saldooekuitas06d_xx<>0){
			$saldo06_ekuitas_xx = $saldooekuitas06d_xx;
		}else{
			$saldo06_ekuitas_v     = $saldooekuitas06c_xx*-1;
			$saldo06_ekuitas_xx = $saldo06_ekuitas_v;
		}
		
		if($saldooekuitas07d_xx<>0){
			$saldo07_ekuitas_xx = $saldooekuitas07d_xx;
		}else{
			$saldo07_ekuitas_v  = $saldooekuitas07c_xx*-1;
			$saldo07_ekuitas_xx = $saldo07_ekuitas_v;
		}
		
		if($saldooekuitas08d_xx<>0){
			$saldo08_ekuitas_xx = $saldooekuitas08d_xx;
		}else{
			$saldo08_ekuitas_v     = $saldooekuitas08c_xx*-1;
			$saldo08_ekuitas_xx = $saldo08_ekuitas_v;
		}
		
		if($saldooekuitas09d_xx<>0){
			$saldo09_ekuitas_xx = $saldooekuitas09d_xx;
		}else{
			$saldo09_ekuitas_v     = $saldooekuitas09c_xx*-1;
			$saldo09_ekuitas_xx    = $saldo09_ekuitas_v;
		}
		...
		if($saldooekuitas10d_xx<>0){
			...
			$saldo10_ekuitas_v  = $saldooekuitas10c_xx*-1;
			$saldo10_ekuitas_xx = $saldo10_ekuitas_v;
		}

		if($saldooekuitas11d_xx<>0){
			$saldo11_ekuitas_xx = $saldooekuitas11d_xx;
		}else{
			$saldo11_ekuitas_v     = $saldooekuitas11c_xx*-1;
			$saldo11_ekuitas_xx = $saldo11_ekuitas_v;
		}
		
		if($saldooekuitas12d_xx<>0){
			$saldo12_ekuitas_xx = $saldooekuitas12d_xx;
		}else{
			$saldo12_ekuitas_v  = $saldooekuitas12c_xx*-1;
			$saldo12_ekuitas_xx = $saldo12_ekuitas_v;
		}
...
if($group_n == 'Other Expenses'){
	...
	if($b['type'] == 'G'){
        ...
        if($b['saldo05d']<>0){
            $sum05_biaya_lainnya += $b['saldo05d'];
        }else{
            if ($b['saldo05c'] > 0){
...
<td style="text-align: right;<?php echo $bolds;?>">
    ...
    //+$saldo09_aset+$saldo08_aset+$saldo07_aset+$saldo06_aset+$saldo05_aset+$saldo04_aset+$saldo03_aset+$saldo02_aset+$saldo01_aset
		...
		if($saldoobiayalainnya09d_xx<>0){
            ...
            if ($saldoobiayalainnya09c_xx > 0){
                $saldo09_biaya_lainnya_xx = $saldoobiayalainnya09c_xx*-1;
            }else if ($saldoobiayalainnya09c_xx < 0){
                $saldo09_biaya_lainnya_xx = $saldoobiayalainnya09c_xx;
            }else if ($saldoobiayalainnya09c_xx == 0){
        ...
        if($b['type'] == 'G'){
			$totaltb_biayalainnya   += 0;
		}else{
			$totaltb_biayalainnya   += $totalbiayalainnya_x;
		}
...
$tot_sum_year= ($saldo_year_aset_x+$saldo_year_kewajiban_x)+($saldo_year_ekuitas_x+$saldo_year_biaya_x+$saldo_year_biaya_x+$saldo_year_pendapatan_x+$yeard_pendapatan_lainnya_x+$saldo_year_biaya_lainnya_x);
...
$tot_sum_all = ($totaltb_aset+$totaltb_kewajiban)+($totaltb_ekuitas+$totaltb_biaya+$totaltb_pendapatan+$totaltb_pendapatanlainnya+$totaltb_biayalainnya);
//echo " ASET:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($totaltb_aset,0))."| KEWAJIBAN:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($totaltb_kewajiban,0))."| EKUITAS:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_ekuitas,0))."| BIAYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_biaya,0))."| PENDAPATAN_LAINNYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_pendapatan_lainnya,0))."| PENDAPATAN:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_pendapatan,0))."| BIAYA LAINNYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_biaya_lainnya,0));;

//+($totaltb_ekuitas+$totaltb_biaya+$totaltb_pendapatan+$totaltb_pendapatanlainnya+$totaltb_biayalainnya)
//DI TOT_SUM_ALL TIDAK PER DITAMBAH EKUITAS :$totaltb_ekuitas+
?>

<!-- GRAND TOTAL -->   
<tr>
<td colspan="2" align="right">&nbsp;Saldo Balance</td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_year,0));?></td>
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_all,0));?></td>
<!-- GRAND TOTAL 


echo " ASET:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_aset,0))."| KEWAJIBAN:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_kewajiban,0))."| EKUITAS:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_ekuitas,0))."| BIAYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_biaya,0))."| PENDAPATAN_LAINNYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_pendapatan_lainnya,0))."| PENDAPATAN:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_pendapatan,0))."| BIAYA LAINNYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum01_biaya_lainnya,0));;

echo " ASET:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum05_aset,0))."| KEWAJIBAN:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum05_kewajiban,0))."| EKUITAS:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum05_ekuitas,0))."| BIAYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum05_biaya,0))."| PENDAPATAN_LAINNYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum05_pendapatan_lainnya,0))."| PENDAPATAN:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum05_pendapatan,0))."| BIAYA LAINNYA:".preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum05_biaya_lainnya,0));;

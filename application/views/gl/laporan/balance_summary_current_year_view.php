...
<tr>
    ...
    <?php 
        ...
        if($bln == '01'){
            ...
            $db_aset_lancar = $a['yeard']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '03'){
        ...
        //var_dump("TOT DB : ".$db_aset_lancar." TOT CR : ".$cr_aset_lancar);
        //exit();
...
?>
<tr>
    <td style="font-weight:bold;height: 30px;font-size:11px">&nbsp;
        TOTAL ASET LANCAR <!-- Revenue -->
    </td>
    <td align="right" style="font-size:11px"><b>&nbsp;&nbsp; 
    <?php 
    //$tot_aset_lancar
    ...
    <?php 
        ...
        if($bln == '01'){
           ...
           $cr_aset_tidak_lancar  = $a['yearc']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
            ...
            $cr_aset_tidak_lancar = $a['yearc']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '10'){
            $cr_aset_tidak_lancar = $a['yearc']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '11'){
            $cr_aset_tidak_lancar = $a['yearc']+$a['saldo11c']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '12'){
            $cr_aset_tidak_lancar = $a['yearc']+$a['saldo12c']+$a['saldo11c']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }
        ...
        if($bln == '01'){
            ...
            $db_aset_tidak_lancar = $a['yeard']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '03'){
            ...
            $db_aset_tidak_lancar = $a['yeard']+$a['saldo10d']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '11'){
            ...
            $db_aset_tidak_lancar = $a['yeard']+$a['saldo12d']+$a['saldo11d']+$a['saldo10d']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }
...
<tr>
    ...
    <td align="right" style="font-size:11px">&nbsp;&nbsp;<b><?php 
...
<tr>
    ...
    <td align="right" style="font-weight:bold;font-size: 14px">&nbsp;&nbsp;<?php 
    ...
    <?php 
        ...
        if($bln == '01'){
           ...
           $cr = $a['yearc']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
            ...
            $cr = $a['yearc']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '11'){
            ...
            $cr = $a['yearc']+$a['saldo12c']+$a['saldo11c']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }
        ...
        if($bln == '01'){
            ...
            $db = $a['yeard']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '03'){
            ...
            $db = $a['yeard']+$a['saldo10d']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '11'){
...
<tr>
    ...
    <td align="right" style="font-weight:bold;font-size: 11px">&nbsp;&nbsp;<?php 
    ...
    <?php 
        ...
        if($bln == '01'){
           ...
           $cr_kw_tidak_lancar = $a['yearc']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
            ...
            $cr_kw_tidak_lancar = $a['yearc']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '11'){
            $cr_kw_tidak_lancar = $a['yearc']+$a['saldo11c']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '12'){
            $cr_kw_tidak_lancar = $a['yearc']+$a['saldo12c']+$a['saldo11c']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }
        ...
        if($bln == '01'){
            ...
            $db_kw_tidak_lancar = $a['yeard']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '03'){
            ...
            $db_kw_tidak_lancar = $a['yeard']+$a['saldo10d']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '11'){
...
//        (if {@db}=0 and {@CR}<>0 then 
//            if {@CR}>0 then {@CR} else {@CR}
//        else if {@db}<>0 and {@CR}=0 then
//            if {@db}>0 then {@db}*-1 else {@db}
//        else if {@db}<>0 and {@CR}<>0 then
//            {@CR}-{@db}
//            )
        ...
        if($db_kw_tidak_lancar == '0' && $cr_kw_tidak_lancar <> '0'){
            ...
            $v_kw_tidak_lancar = $cr_kw_tidak_lancar-$db_kw_tidak_lancar;
            $tot_kw_tidak_lancar +=$v_kw_tidak_lancar;
            echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($v_kw_tidak_lancar,0));
        }
    ?>
...
<tr>
    ...
    <?php 
        ...
        if($bln == '01'){
           ...
           $cr_ekuitas = $a['yearc']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
            ...
            $cr_ekuitas = $a['yearc']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '10'){
            $cr_ekuitas = $a['yearc']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '11'){
            $cr_ekuitas = $a['yearc']+$a['saldo11c']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }else if($bln == '12'){
            $cr_ekuitas = $a['yearc']+$a['saldo12c']+$a['saldo11c']+$a['saldo10c']+$a['saldo09c']+$a['saldo08c']+$a['saldo07c']+$a['saldo06c']+$a['saldo05c']+$a['saldo04c']+$a['saldo03c']+$a['saldo02c']+$a['saldo01c'];
        }
        ...
        if($bln == '01'){
            ...
            $db_ekuitas = $a['yeard']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '03'){
            ...
            $db_ekuitas = $a['yeard']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '10'){
            $db_ekuitas = $a['yeard']+$a['saldo10d']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '11'){
            $db_ekuitas = $a['yeard']+$a['saldo11d']+$a['saldo10d']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }else if($bln == '12'){
            $db_ekuitas = $a['yeard']+$a['saldo12d']+$a['saldo11d']+$a['saldo10d']+$a['saldo09d']+$a['saldo08d']+$a['saldo07d']+$a['saldo06d']+$a['saldo05d']+$a['saldo04d']+$a['saldo03d']+$a['saldo02d']+$a['saldo01d'];
        }
    ...
    //exit();
        if($db_ekuitas == '0' && $cr_ekuitas <> '0'){
            ...
            $v_ekuitas = $cr_ekuitas-$db_ekuitas;
            $tot_ekuitas +=$v_ekuitas;
            echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($v_ekuitas,0));
        }

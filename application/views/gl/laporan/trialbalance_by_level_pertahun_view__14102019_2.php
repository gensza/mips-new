...
<title>Trial Balance Tahunan</title>
...
?>
<tr>
    <td align="center" width="10%" style="<?php echo $bolds;?>">&nbsp;<?php echo $noac_n;?> - <?php echo $b['type'];?> - <?php echo $b['level'];?></td>
...
?>
<tr>
<td align="center" width="10%" style='<?php echo $bold_cap;?>'>&nbsp;<?php echo $noac_n;?> - <?php echo $b['type'];?> - <?php echo $b['level'];?></td>
...
?>
<tr>
<td align="center" width="10%">&nbsp;<?php echo $noac_n;?> - <?php echo $b['type'];?> - <?php echo $b['level'];?></td>
...
?>
<tr>
<td align="center" width="10%" style="<?php echo $bold_liab;?>">&nbsp;<?php echo $noac_n;?> - <?php echo $b['type'];?> - <?php echo $b['level'];?></td>
...
$tot_sum_02 = ($sum02_aset+$sum02_kewajiban)+($sum02_ekuitas+$sum02_biaya+$sum02_pendapatan_lainnya+$sum02_pendapatan+$sum02_biaya_lainnya);
$tot_sum_03 = ($sum03_aset+$sum03_kewajiban)+($sum03_ekuitas+$sum03_biaya+$sum03_pendapatan_lainnya+$sum03_pendapatan+$sum03_biaya_lainnya);
$tot_sum_04 = ($sum04_aset+$sum04_kewajiban)+($sum04_ekuitas+$sum04_biaya+$sum04_pendapatan_lainnya+$sum04_pendapatan+$sum04_biaya_lainnya);
$tot_sum_05 = ($sum05_aset+$sum05_kewajiban)+($sum05_ekuitas+$sum05_biaya+$sum05_pendapatan_lainnya+$sum05_pendapatan+$sum05_biaya_lainnya);
$tot_sum_06 = ($sum06_aset+$sum06_kewajiban)+($sum06_ekuitas+$sum06_biaya+$sum06_pendapatan_lainnya+$sum06_pendapatan+$sum06_biaya_lainnya);
$tot_sum_07 = ($sum07_aset+$sum07_kewajiban)+($sum07_ekuitas+$sum07_biaya+$sum07_pendapatan_lainnya+$sum07_pendapatan+$sum07_biaya_lainnya);
$tot_sum_08 = ($sum08_aset+$sum08_kewajiban)+($sum08_ekuitas+$sum08_biaya+$sum08_pendapatan_lainnya+$sum08_pendapatan+$sum08_biaya_lainnya);
$tot_sum_09 = ($sum09_aset+$sum09_kewajiban)+($sum09_ekuitas+$sum09_biaya+$sum09_pendapatan_lainnya+$sum09_pendapatan+$sum09_biaya_lainnya);
$tot_sum_10 = ($sum10_aset+$sum10_kewajiban)+($sum10_ekuitas+$sum10_biaya+$sum10_pendapatan_lainnya+$sum10_pendapatan+$sum10_biaya_lainnya);
$tot_sum_11 = ($sum11_aset+$sum11_kewajiban)+($sum11_ekuitas+$sum11_biaya+$sum11_pendapatan_lainnya+$sum11_pendapatan+$sum11_biaya_lainnya);
$tot_sum_12 = ($sum12_aset+$sum12_kewajiban)+($sum12_ekuitas+$sum12_biaya+$sum12_pendapatan_lainnya+$sum12_pendapatan+$sum12_biaya_lainnya);
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_02,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_03,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_04,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_05,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_06,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_07,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_08,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_09,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_10,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_11,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_sum_12,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format(0,0));?></td>
<!-- GRAND TOTAL 

echo " ASET:".$sum01_aset."| KEWAJIBAN:".$sum01_kewajiban."| EKUITAS:".$sum01_ekuitas."| BIAYA:".$sum01_biaya."| PENDAPATAN_LAINNYA:".$sum01_pendapatan_lainnya."| PENDAPATAN:".$sum01_pendapatan."| BIAYA LAINNYA:".$sum01_biaya_lainnya;

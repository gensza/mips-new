            ...
            $("#btn_posting").click(function() {
                  ...
                  if ($("#password").val() == '') {
                        ...
                        if ($("#password").val() != '12345') {
                              ...
                              swal({
                                          title: "Transfer Transaksi ke HO Sekarang ?",
                                          text: "Jika ingin transfer, silahkan klik button simpan",
                                          type: "info",
                                    ...
                                    function() {
                                          ...
                                          $.ajax({
                                                url: base_url + 'gl/posting_transfer_trx_to_ho',
                                                type: "POST",
                                                dataType: 'json',
...
<nav>
      <div id="jCrumbs" class="breadCrumb module">
            <ul>
                  ...
                  <li>
                        <a href="#">Posting / Transfer Transaksi ke HO</a>
                  </li>
            </ul>
      </div>
</nav>

<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tabel_coa').DataTable({
            ...
            "ajax": {
                url: base_url + 'cash_bank/mastercode_popup',
                type: 'POST',
                data: {
        ...
        pilih = function(acct_no, acct_id) {

            $.ajax({
                url: base_url + 'cash_bank/detail_account',
                type: "post",
                dataType: 'json',
                data: {
                    acct_no: acct_no,
...
<div class="modal fade" id="<?php echo $id_modal; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <div class="table-responsive">
            <table id="tabel_coa" class="table table-hover table-striped" style="width: 100%">
                <thead>
                    <tr>

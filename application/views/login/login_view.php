...
<body>
    ...
    <div class="login_box" style="padding-top: 20px;">

        <div style="width: 100%;text-align: center;">
            <img src="<?php echo base_url('assets/theme/adm2/img/logo.jpg'); ?>" style="width: 40px">
            <br>
            <br>
            <span style="font-weight: bold;font-size:25px">MIPS</span>
            <br>
        ...
        line-height:30px;"></select>
            ...
            <div class="btm_b clearfix">
                ...
                <span class="link_reg"><a href="#pass_form">MIPS V.0.1</a></span>
            </div>
        </form>

        <div class="links_b links_btm clearfix" style="color:gray">
            Copyright &copy; PT MSAL GROUP | MIS <?php echo date('Y'); ?>
        </div>

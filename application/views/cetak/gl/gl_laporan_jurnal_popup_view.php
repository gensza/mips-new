...
<table width="100%" border="0" align="center" class="font-styles">
    <tr>
        ...
        <td width="17%">
            <div style="width: 100%;text-align: right;font-size: 12px" class="font-styles"><i>Generated By System MIPS GL</i></div>
    ...
    <tbody>
        ...
        ?>
                    <tr style="border: 0px solid #FFFFFF;">
                        ...
                        <td align="left">
                            <div style="padding-left:3%"><?php echo $a['descac']; ?></div>
                        </td>

...
<table width="100" border="1">
  <tbody>
    ...
    <tr>
      ...
      <td width="93" height="10" colspan="4" class="ukuran_teks" align="right">
        <br>
        <?php echo $h_vouc['TGL']; ?>
      </td>
    </tr>
    <tr>
      ...
      <td align="center" colspan="5" class="ukuran_teks" style="border-left: 0px solid #FFF;"></td>
    </tr>
    <tr>
      <td height="20" colspan="2" align="center" class="ukuran_teks">
        <p style="display: none;">Perkiraan</p>
      </td>
      <td colspan="5" align="center" class="ukuran_teks">
    ...
    ?>
        <tr>
          <td height="10" colspan="2" align="left" class="ukuran_teks">&nbsp; <?php echo $v['DT_ACCTNO'] . '   ' . $v['KODE_PT']; ?></td>
          <td colspan="5" class="ukuran_teks" style="width:50px;padding:5px">
    ...
    ?>
    <tr>
      <td height="100" colspan="7" align="left" class="ukuran_teks" valign="top">&nbsp;<br>
        <i>
          <?php
    ...
    <tr>
      ...
      <td colspan="6" style="background : gray" class="ukuran_teks">&nbsp; </td>
    </tr>
    <tr>

...
<table width="100%" border="0">
    <tr>
        ...
        <td><span style="font-size: 18px;font-weight: normal;">Laporan Pertanggung Jawaban</span></td>
        <td></td>
        <td style="text-align: right;font-size: 10px">Tanggal : <?php echo date("m/d/Y"); ?></td>
    </tr>
    <tr>
        ...
        <td></td>
        <td style="text-align: right;font-size: 10px"> Waktu : <?php
        ...
        <?php if (empty($res_data_head)) { ?>
            ...
            ?>
                    <tr>
                        ...
                        <td align="right" width="150px">0</td>
                    </tr>
            <?php }
                        }

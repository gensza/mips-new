...
MySQL - 5.5.5-10.1.34-MariaDB : Database - db_mips_conf
*********************************************************************
*/
...
insert  into `module_permission`(`id_module_role`,`id_module`,`cbx`) values (1,1,1),(1,3,1),(1,2,1),(1,4,1),(1,5,1),(3,55,1),(3,61,1),(3,62,1),(3,63,1),(3,64,1),(3,56,1),(3,65,1),(3,57,1),(3,66,1),(3,67,1),(3,68,1),(3,58,1),(3,69,1),(3,71,1),(3,72,1),(3,73,1),(3,74,1),(3,70,1),(3,59,1),(3,75,1),(3,76,1),(3,77,1),(3,78,1),(3,79,1),(3,80,1),(3,81,1),(3,60,1),(2,6,1),(2,12,1),(2,13,1),(2,14,1),(2,15,1),(2,16,1),(2,17,1),(2,7,1),(2,18,1),(2,19,1),(2,20,1),(2,8,1),(2,21,1),(2,22,1),(2,23,1),(2,82,1),(2,9,1),(2,24,1),(2,25,1),(2,10,1),(2,26,1),(2,36,1),(2,37,1),(2,27,1),(2,28,1),(2,29,1),(2,38,1),(2,39,1),(2,30,1),(2,40,1),(2,41,1),(2,31,1),(2,42,1),(2,43,1),(2,32,1),(2,44,1),(2,45,1),(2,33,1),(2,46,1),(2,47,1),(2,34,1),(2,35,1),(2,11,1),(2,48,1),(2,49,1),(2,50,1),(2,51,1),(2,52,1),(2,53,1),(2,54,1);
...
/*Table structure for table `site_kode` */

DROP TABLE IF EXISTS `site_kode`;

CREATE TABLE `site_kode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `site_kode` */

insert  into `site_kode`(`id`,`id_pt`,`kode`,`nama`,`inisial`,`is_deleted`) values (1,1,'111','HO-MSAL-HO','HOMSHO',0),(2,1,'112','HO-MSAL-RO','HOMSRO',0),(3,1,'113','HO-MSAL-KEBUN','HOMSKB',0),(4,1,'114','HO-MSAL-PABRIK','HOMSPB',0),(5,1,'115','HO-MSAL-MITRA','HOMSMT',0),(6,1,'121','HO-PSAM-HO','HOPMHO',0),(7,1,'122','HO-PSAM-RO','HOPMRO',0),(8,1,'123','HO-PSAM-KEBUN','HOPMKB',0),(9,1,'124','HO-PSAM-PABRIK','HOPMPB',0),(10,1,'125','HO-PSAM-MITRA','HOPMMT',0),(11,1,'131','HO-MAPA-HO','HOMPHO',0),(12,1,'132','HO-MAPA-RO','HOMPRO',0),(13,1,'133','HO-MAPA-KEBUN','HOMPKB',0),(14,1,'134','HO-MAPA-PABRIK','HOMPPB',0),(15,1,'135','HO-MAPA-MITRA','HOMPMT',0),(16,1,'141','HO-PEAK-HO','HOPKHO',0),(17,1,'142','HO-PEAK-RO','HOPKRO',0),(18,1,'143','HO-PEAK-KEBUN','HOPKKB',0),(19,1,'144','HO-PEAK-PABRIK','HOPKPB',0),(20,1,'145','HO-PEAK-MITRA','HOPKMT',0),(21,2,'210','MSAL-RO','MSALRO',0),(22,2,'220','MSAL-KEBUN','MSALKB',0),(23,2,'230','MSAL-PABRIK','MSALPB',0),(24,2,'240','MSAL-MITRA','MSALMT',0),(25,3,'310','PSAM-RO','PSAMRO',0),(26,3,'320','PSAM-KEBUN','PSAMKB',0),(27,3,'330','PSAM-PABRIK','PSAMPB',0),(28,3,'340','PSAM-MITRA','PSAMMT',0),(30,4,'410','MAPA-RO','MAPARO',0),(31,4,'420','MAPA-KEBUN','MAPAKB',0),(32,4,'430','MAPA-PABRIK','MAPAPB',0),(33,4,'440','MAPA-MITRA','MAPAMT',0),(34,5,'510','PEAK-RO','PAEKRO',0),(35,5,'520','PEAK-KEBUN','PEAKKB',0),(36,5,'530','PEAK-PABRIK','PEAKPB',0),(37,5,'540','PEAK-MITRA','PEAKMT',0);

/*Table structure for table `site_mitra` */

DROP TABLE IF EXISTS `site_mitra`;

CREATE TABLE `site_mitra` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `kode` varchar(20) DEFAULT NULL,
  `nama` varchar(100) DEFAULT NULL,
...
/*Data for the table `site_mitra` */

insert  into `site_mitra`(`id`,`kode`,`nama`,`ket`,`is_deleted`) values (1,'115','1151','MITRA 1 HO MSAL',0),(2,'115','1152','MITRA 2 HO MSAL',0),(3,'115','1153','MITRA 3 HO MSAL',0),(4,'115','1154','MITRA 4 HO MSAL',0),(5,'125','1251','MITRA 1 HO PSAM',0),(6,'125','1252','MITRA 2 HO PSAM',0),(7,'125','1253','MITRA 3 HO PSAM',0),(8,'125','1254','MITRA 4 HO PSAM',0),(9,'135','1351','MITRA 1 HO MAPA',0),(10,'135','1352','MITRA 2 HO MAPA',0),(11,'135','1353','MITRA 3 HO MAPA',0),(12,'135','1354','MITRA 4 HO MAPA',0),(13,'145','1451','MITRA 1 HO PEAK',0),(14,'145','1452','MITRA 2 HO PEAK',0),(15,'145','1453','MITRA 3 HO PEAK',0),(16,'145','1454','MITRA 4 HO PEAK',0),(17,'240','241','MITRA 1 MSAL',0),(18,'240','242','MITRA 2 MSAL',0),(19,'240','243','MITRA 3 MSAL',0),(20,'240','244','MITRA 4 MSAL',0),(21,'340','341','MITRA 1 PSAM',0),(22,'340','342','MITRA 2 PSAM',0),(23,'340','343','MITRA 3 PSAM',0),(24,'340','344','MITRA 4 PSAM',0),(25,'440','441','MITRA 1 MAPA',0),(26,'440','442','MITRA 2 MAPA',0),(27,'440','443','MITRA 3 MAPA',0),(28,'440','444','MITRA 4 MAPA',0),(29,'540','541','MITRA 1 PEAK',0),(30,'540','542','MITRA 2 PEAK',0),(31,'540','543','MITRA 3 PEAK',0),(32,'540','544','MITRA 4 PEAK',0);
...
CREATE TABLE `site_pt` (
  ...
  `inis_db` varchar(50) DEFAULT NULL,
  `deskripsi` text,
...
insert  into `site_pt`(`id`,`nama`,`inisial`,`inis_db`,`deskripsi`,`logo`,`is_deleted`) values (1,'HO','HO','ho',NULL,NULL,0),(2,'PT. MULIA SAWIT AGRO LESTARI','MSAL','msal',NULL,'msal.jpeg',0),(3,'PT. PERSADA SEJAHTERA AGRO MAKMUR','PEAK','peak',NULL,'psam.jpeg',0),(4,'PT. MITRA AGRO PERSADA ABADI','MAPA','mapa',NULL,'mapa.jpeg',0),(5,'PT. PERSADA ERA AGRO KENCANA','PSAM','peak',NULL,'peak.jpeg',0);
...
CREATE TABLE `users` (
  ...
  `id_site_kode` int(11) DEFAULT NULL,
...
insert  into `users`(`id`,`id_pt`,`id_lokasi`,`id_site_kode`,`nama`,`email`,`username`,`password`,`id_module_role`,`login_lst`,`login_exp`,`token`,`aktif`,`avatar`,`cookie`,`group_modul`,`is_deleted`,`created_by`,`created_at`,`updated_by`,`updated_at`) values (1,2,1,NULL,'Saeful Bahri','sf.bahri@yahoo.co.id','superadmin','e61eb30e63a83beec52c360479c17470e15459225db4aa45dfb73b167421256d8de86ac161189e347b1835ac1f75a7a707a9e5710c2d8453d6bd3968e71d5ad1',1,'2019-09-05 13:26:45','2019-09-05 17:26:45','eymmL2qSlI8OepX',1,'assets/avatar/av_201220171513703226H17DD.png',NULL,0,0,NULL,NULL,0,'2019-08-27 11:40:54'),(14,2,1,NULL,'Saeful Bahri','gl@gmail.com','glho','e61eb30e63a83beec52c360479c17470e15459225db4aa45dfb73b167421256d8de86ac161189e347b1835ac1f75a7a707a9e5710c2d8453d6bd3968e71d5ad1',2,'2019-09-06 15:08:50','2019-09-06 19:08:50','GsC8PphXy98Mjbe',1,NULL,NULL,1,0,0,'2019-07-18 09:48:47',0,'2019-08-27 11:40:45'),(15,2,3,NULL,'Saeful Bahri','gl@gmail.com','gles','e61eb30e63a83beec52c360479c17470e15459225db4aa45dfb73b167421256d8de86ac161189e347b1835ac1f75a7a707a9e5710c2d8453d6bd3968e71d5ad1',2,NULL,NULL,NULL,1,NULL,NULL,1,0,0,'2019-07-18 09:49:22',0,'2019-09-03 09:10:41'),(16,2,1,NULL,'Saeful Bahri','c@gmail.com','cbho','e61eb30e63a83beec52c360479c17470e15459225db4aa45dfb73b167421256d8de86ac161189e347b1835ac1f75a7a707a9e5710c2d8453d6bd3968e71d5ad1',3,'2019-09-06 13:31:21','2019-09-06 17:31:21','oFrlpuIeq4O3Dku',1,NULL,NULL,2,0,0,'2019-07-18 11:58:33',0,'2019-08-27 11:41:14'),(17,2,3,NULL,'Saeful Bahri','c@gmail.com','cbes','e61eb30e63a83beec52c360479c17470e15459225db4aa45dfb73b167421256d8de86ac161189e347b1835ac1f75a7a707a9e5710c2d8453d6bd3968e71d5ad1',3,'2019-09-03 09:14:46','2019-09-03 13:14:46','7Nsqiyr9kW852lm',1,NULL,NULL,2,0,0,'2019-07-18 11:58:59',0,'2019-09-03 09:11:00');

...
$(document).ready(function(){
    ...
    $("#btn_tampilkan_popup").click(function(){
      ...
      //window.open(base_url+'cetak/cash_bank_lap_register/'+tgl_start+'/'+tgl_end+'');
        ...
        var url = '<?php echo base_url('cetak/gl_lap_bukubesar_popup/');?>';
  ...
  $("#btn_tampilkan").click(function(){
    ...
    if($('#chx_periode').val() == 1){
      ...
      $.ajax({ 
                url: base_url + 'gl/report_buku_besar_view',
                type: "post",
...
<input type='hidden' class='form-control' name='<?php echo $this->security->get_csrf_token_name(); ?>' value="<?php echo $this->security->get_csrf_hash(); ?>">
  ...
  <div class="row-fluid">
  <div class="span6" >
      <h3 class="heading">Report Buku Besar</h3>
    ...
    min-width: 100px;
      ...
      <div class="span6" style="display:none;width:100px" id="tbl_vouc_regis" >

           
                              <table id="tabel_lap_vouc_jurnal" class"table table-striped">

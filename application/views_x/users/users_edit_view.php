                        ...
                        success: function (data) {
                            $('#pt_edit').empty();
                                        ...
                                        for (var i = 0; i < data.length; i++) {
                                            ...
                                            if(res.id_pt == data[i].id){
                                                $kategori.append('<option value=' + data[i].id + ' selected>'+ data[i].inisial +' - '+ data[i].nama + '</option>');
                                            }else{
...
<div class="modal hide modal-sm" id="<?php echo $id_modal;?>">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" class="form-control" name="idpengguna" id="idpengguna">

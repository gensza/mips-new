...
$(document).ready(function(){
    ...
    $('.maskmoney_money').maskMoney({thousands:',', decimal:'.', precision:0,});
          ...
          Command: toastr["error"]("Silahkan masukan Nilai Saldo !", "Error");
           $("#nilai_saldo").focus();
            ...
            $.ajax({ 
              ...
              type: "post",
              data:{acctno : $("#acctno").val(),tahun:tahun_periode,
                ...
                if(result == 1){
                  ...
                  //ini jika ada data noac dan tahun, maka proses update
                    $.ajax({ 
                        ...
                        type: "post",
                        data:{acctno : $("#acctno").val(),tahun:tahun_periode,bulan:bulan_periode,acctname:$("#acctname").val(),saldo:$("#nilai_saldo").val(),
                          <?php echo $this->security->get_csrf_token_name(); ?>:'<?php echo $this->security->get_csrf_hash(); ?>'},
                        dataType: "json",
                        async : 'false',
                        success: function(result)

    ...
    function master_update($data){
        ...
        function get_data_entry($periode_terkini,$tgl_start,$tgl_end,$divisi_start,$divisi_end,$noacc_start,$noacc_end){
            ...
            if($periode_terkini == 1){ //ini artinya pakai periode, filter tanggal tidak berlaku
                ...
                $sql = "SELECT *,DATE_FORMAT(`DATE`, '%d-%m-%Y') TGL,dr DEBET_F2,FORMAT(dr, 2) DEBET_F,FORMAT(cr, 2) CREDIT_F FROM entry WHERE SUBSTR(periodetxt,1,6) = '$sess_periode' AND lokasi = '$sess_lokasi' $dv_start $acc ORDER BY `DATE`,dr DESC";
                return $this->mips_gl->query($sql);

            }else{

                $sql = "SELECT *,DATE_FORMAT(`DATE`, '%d-%m-%Y') TGL,dr DEBET_F2,FORMAT(dr, 2) DEBET_F,FORMAT(cr, 2) CREDIT_F FROM entry WHERE DATE(`DATE`) >= STR_TO_DATE('$tgl_start', '%d-%m-%Y') AND DATE(`DATE`) <= STR_TO_DATE('$tgl_end', '%d-%m-%Y') AND lokasi = '$sess_lokasi' $dv_start $acc  ORDER BY `DATE`,dr DESC";
                return $this->mips_gl->query($sql);
        ...
        function get_data_acct_buku_besar($periode_terkini,$tgl_start,$tgl_end,$divisi_start,$divisi_end,$noacc_start,$noacc_end){
            ...
            if($periode_terkini == 1){ //ini artinya pakai periode, filter tanggal tidak berlaku
                ...
                //$sql = "SELECT DISTINCT noac,descac FROM entry WHERE SUBSTR(periodetxt,1,6) = '$sess_periode' AND lokasi = '$sess_lokasi' $dv_start $acc ORDER BY noac ASC";
                return $this->mips_gl->query($sql);
        ...
        function get_data_entry_buku_besar($periode_terkini,$tgl_start,$tgl_end,$divisi_start,$divisi_end,$noacc_start,$noacc_end){
            ...
            if($periode_terkini == 1){ //ini artinya pakai periode, filter tanggal tidak berlaku
                ...
                $sql = "SELECT *,DATE_FORMAT(`DATE`, '%d-%m-%Y') TGL,dr DEBET_F2,FORMAT(dr, 2) DEBET_F,FORMAT(cr, 2) CREDIT_F FROM entry WHERE SUBSTR(periodetxt,1,6) = '$sess_periode' AND lokasi = '$sess_lokasi' $dv_start $acc ORDER BY noac ASC";
                return $this->mips_gl->query($sql);

            }else{

                $sql = "SELECT *,DATE_FORMAT(`DATE`, '%d-%m-%Y') TGL,dr DEBET_F2,FORMAT(dr, 2) DEBET_F,FORMAT(cr, 2) CREDIT_F FROM entry WHERE DATE(`DATE`) >= STR_TO_DATE('$tgl_start', '%d-%m-%Y') AND DATE(`DATE`) <= STR_TO_DATE('$tgl_end', '%d-%m-%Y') AND lokasi = '$sess_lokasi' $dv_start $acc  ORDER BY noac ASC"; /*ORDER BY `DATE`,dr DESC*/
                return $this->mips_gl->query($sql);
...
//                        
                        ...
                        $sql_act_grs = "UPDATE noac SET ".$KREDIT."= '1',
                                                        ".$DEBIT." = '1',
                                                        balancedr = 0,
...
//                        }
                        ...
                        $sql_act_grd = "UPDATE noac SET ".$KREDIT."= '2',
                                                        ".$DEBIT." = '2',
                                                        balancedr    = 0,
                                                        balanceCr    = 0 WHERE noac = '$a[noac]'";

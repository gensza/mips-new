...
class Member_model extends CI_Model{	
    ...
    function simpan($data,$nama_file){
        ...
        $sql = "INSERT INTO berita (id_users,judul,gambar,deskripsi,created_by,created_at) VALUES ('$user_nik','$data[judul]','$nama_file','$data[deskripsi]',$user_nik,NOW())";
        return $this->db->query($sql);
    }

    function data(){
        $sql = "SELECT * FROM member WHERE is_deleted = 0 ORDER BY id ASC";
        return $this->db->query($sql);
    }

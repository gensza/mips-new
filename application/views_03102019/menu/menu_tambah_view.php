        ...
        function(){
            ...
            $.ajax({
                ...
                if(response == true){
                        $('#'+id_modal).modal('hide');   
                        swal.close();
                        Command: toastr["success"]("Menu Web berhasil disimpan", "Berhasil");
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
        <div class="modal-header pd-y-20 pd-x-25">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Tambah Menu Web</h6>
      ...
      <div class="modal-body">
          <div class="row">  
            ...
            <div class="col-md-12">
                <div class="form-group">
                <label for="demo-vs-definput" class="control-label">Punya Submenu ?</label>

...
<span style="font-size:14px;font-weight: bold"><i>Sort By Level <?php echo $level;?></i></span>
<br>
...
$subtotal_aset_tm_cr;
$subtotal_aset_balance-->
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_aset_bb_c, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_aset_bb_d, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_aset_tm_db, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_aset_tm_cr, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_aset_balance, 0);?></td>
</tr>
<!-- ASSETS -->
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_ekuitas_bb_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_ekuitas_bb_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_ekuitas_tm_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_ekuitas_tm_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_ekuitas_balance,0);?></td>
</tr>
<!-- EKUITAS -->
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_bb_db, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_bb_cr, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_tm_db, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_tm_cr, 0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_balance, 0);?></td>
</tr>
<!-- BIAYA -->
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($$subtotal_kewajiban_bb_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_kewajiban_bb_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_kewajiban_tm_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_kewajiban_tm_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_kewajiban_balance,0);?></td>
</tr>
<!-- KEWAJIBAN -->
...
<td style="text-align: right">
    <?php 
        ...
        $subtotal_biaya_lainnya_tm_db += $crt;
        echo number_format($crt, 0);
        ?>
</td>
<td style="text-align: right">
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_lainnya_bb_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_lainnya_bb_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_lainnya_tm_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_lainnya_tm_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_biaya_lainnya_balance,0);?></td>
</tr>
<!-- BIAYA LAINNYA -->
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_lainnya_bb_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_lainnya_bb_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_lainnya_tm_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_lainnya_tm_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_lainnya_balance,0);?></td>
</tr>
<!-- PENDAPATAN LAINNYA -->
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_bb_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_bb_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_tm_db,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_tm_cr,0);?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo number_format($subtotal_pendapatan_balance,0);?></td>
</tr>
<!-- PENDAPATAN -->

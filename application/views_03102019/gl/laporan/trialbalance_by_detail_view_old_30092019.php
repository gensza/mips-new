...
<td style="background:#f1f1f1;text-align: right;font-weight:bold">&nbsp;<?php echo number_format($subtotal_ekuitas_balance,0);?></td>
</tr>
<!-- EKUITAS -->
...
<td style="background:#f1f1f1;text-align: right;font-weight:bold">&nbsp;<?php echo number_format($subtotal_kewajiban_balance,0);?></td>
</tr>
<!-- KEWAJIBAN -->
...
<td style="background:#f1f1f1;text-align: right;font-weight:bold">&nbsp;<?php echo number_format($subtotal_pendapatan_lainnya_balance,0);?></td>
</tr>
<!-- PENDAPATAN LAINNYA -->
...
<td style="background:#f1f1f1;text-align: right;font-weight:bold">&nbsp;<?php echo number_format($subtotal_pendapatan_balance,0);?></td>
</tr>
<!-- PENDAPATAN -->
...
<td style="background:#f1f1f1;text-align: right;font-weight: bold">&nbsp;
    <?php 
        $sum_credit_begining = ($subtotal_aset_bb_c+$subtotal_kewajiban_bb_cr)+($subtotal_ekuitas_bb_db+$subtotal_pendapatan_bb_db+$subtotal_pendapatan_lainnya_bb_db+$subtotal_biaya_lainnya_bb_db+$subtotal_biaya_bb_db);
        echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sum_credit_begining, 0));
    ?>
</td>
<td style="background:#f1f1f1;text-align: right;font-weight: bold">&nbsp;
    <?php 
        $sum_debit_tm = ($subtotal_aset_tm_db+$subtotal_kewajiban_tm_db)+($subtotal_ekuitas_tm_db+$subtotal_pendapatan_tm_db+$subtotal_pendapatan_lainnya_tm_db+$subtotal_biaya_lainnya_tm_db+$subtotal_biaya_tm_db);

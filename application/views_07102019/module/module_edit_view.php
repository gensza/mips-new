        ...
        $.ajax({ 
            ...
            success: function(result)
            {
                ...
                for ( var i=0 ; i<result.length ; i++ ) {
                    var no = i+1;
                    var link_edit = "<a href='javascript:void(0)' onclick=edit_module_sub("+result[i].id+")><span class='btn btn-default btn-sm' title='Edit Modul Sub'><i class='splashy-pencil'></i></span></a>";
                    var link_hapus = "<a href='javascript:void(0)' onclick=hapus_module_sub("+result[i].id+")><span class='btn btn-default btn-sm' title='Hapus Modul Sub'><i class='splashy-gem_remove'></span></a>";
...
<div class="modal hide" id="<?php echo $id_modal;?>">
                                ...
                                <div class="modal-body">  
                                    ...
                                    <div class="form-group">
                                        <label for="demo-vs-definput" class="control-label">Have Child</label>
                                        <input type="text" id="have_child" name="have_child" class="form-control clears" placeholder="Y / N">
                                        <br>
                                        <span style="font-size: 10px">Punya Submenu ? jika tidak silahkan isi dengan 'N' , jika punya : 'Y'</span>
                                    </div>
                                    <br>

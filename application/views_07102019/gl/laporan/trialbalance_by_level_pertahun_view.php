...
<td style="text-align: right;<?php echo $bolds;?>">
    ...
    if($b['saldo10d']<>0){
        ...
        $saldo10_aset = $sal10;
        $ubahformat = preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($sal10,0));
        echo $ubahformat;
    }
    ?>
</td>
...
<?php 
$tot_yeard   = $saldo_yeard_aset_x+$year_ekuitas_x+$year_biaya_x+$year_kewajiban_x;
$tot_saldo01 = $saldo01_aset_x+$saldo01_ekuitas_x+$saldo01_biaya_x+$saldo01_kewajiban_x;
$tot_saldo02 = $saldo02_aset_x+$saldo02_ekuitas_x+$saldo02_biaya_x+$saldo02_kewajiban_x;
$tot_saldo03 = $saldo03_aset_x+$saldo03_ekuitas_x+$saldo03_biaya_x+$saldo03_kewajiban_x;
$tot_saldo04 = $saldo04_aset_x+$saldo04_ekuitas_x+$saldo04_biaya_x+$saldo04_kewajiban_x;
$tot_saldo05 = $saldo05_aset_x+$saldo05_ekuitas_x+$saldo05_biaya_x+$saldo05_kewajiban_x;
$tot_saldo06 = $saldo06_aset_x+$saldo06_ekuitas_x+$saldo06_biaya_x+$saldo06_kewajiban_x;
$tot_saldo07 = $saldo07_aset_x+$saldo07_ekuitas_x+$saldo07_biaya_x+$saldo07_kewajiban_x;
$tot_saldo08 = $saldo08_aset_x+$saldo08_ekuitas_x+$saldo08_biaya_x+$saldo08_kewajiban_x;
$tot_saldo09 = $saldo09_aset_x+$saldo09_ekuitas_x+$saldo09_biaya_x+$saldo09_kewajiban_x;
$tot_saldo10 = $saldo10_aset_x+$saldo10_ekuitas_x+$saldo10_biaya_x+$saldo10_kewajiban_x;
$tot_saldo11 = $saldo11_aset_x+$saldo11_ekuitas_x+$saldo11_biaya_x+$saldo11_kewajiban_x;
$tot_saldo12 = $saldo12_aset_x+$saldo12_ekuitas_x+$saldo12_biaya_x+$saldo12_kewajiban_x;
?>
...
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_saldo01,0));?></td>
<td style="background:#f1f1f1;text-align: right">&nbsp;<?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_saldo02,0));?></td>

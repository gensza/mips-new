...
class Gl_lap_model extends CI_Model{	
    ...
    function trialbalance_by_group($noac){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        level
                 FROM noac WHERE general = '$noac' ORDER BY noac ASC";
    ...
    function get_coa_expenses_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Expenses' and `level` <= '$level' AND ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_coa_revenue_by_level($thn,$bln,$level){
        ...
        $sql = "SELECT  saldo01c,
                        ...
                        `type`,
                        `level`
                 FROM noac WHERE `group` = 'Revenue' and `level` <= '$level' AND noac IN ('600101010000000','600101050000000','600101100000000') ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
...
OR saldo10c <> 0 OR saldo10d <> 0
OR saldo11c <> 0 OR saldo11d <> 0
OR saldo12c <> 0 OR saldo12d <> 0) ORDER BY noac ";
        return $this->mips_gl->query($sql);
...
OR saldo12c <> 0 OR saldo12d <> 0) ORDER BY noac ASC";
    ...
    function income_summary_revenue_detail($bln,$level,$level2){
        ...
        $sql = "SELECT * FROM noac where `group` = 'Revenue' and `level` IN ('$level','$level2') ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function income_summary_expenses_detail($bln,$level,$level2){
        ...
        $sql = "SELECT * FROM noac where `group` = 'Expenses' and `level` IN ('$level','$level2') ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function income_summary_other_revenue_detail($bln,$level,$level2){
        ...
        $sql = "SELECT * FROM noac where `group` = 'Other Revenue' and `level` IN ('$level','$level2') ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function income_summary_other_expenses_detail($bln,$level,$level2){
        ...
        $sql = "SELECT * FROM noac where `group` = 'Other Expenses' and `level` IN ('$level','$level2') ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function balanace_aset_lancar($level,$bulan){
    ...
    function balance_aset_tidak_lancar($level,$bulan){
        
        $filters_null = $this->set_filter_year();
        
        $sql = "SELECT * FROM noac WHERE `group` = 'Asset' AND `level` = '$level' and noac <> '203500000000000' AND SUBSTR(noac,1,2) = '20' $filters_null ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
        
    }
    
    function balance_ekuitas($level,$bulan){
    ...
    function balance_kewajiban_lancar($level,$bulan){
    ...
    function balance_kewajiban_tidak_lancar($level,$bulan){
    ...
    function get_ekuitas_sum($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `group` = 'Capital' AND `level` <= '$level' AND SUBSTR(noac,1,2) = '50' $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);
    ...
    function get_harga_pokok_penjualan($level){
        ...
        $filters_null = $this->set_filter_year();
        $sql = "SELECT * FROM noac WHERE `group` = 'Expenses' AND `level` <= '$level' AND SUBSTR(noac,1,2) = '70' $filters_null  ORDER BY noac ASC";
        return $this->mips_gl->query($sql);

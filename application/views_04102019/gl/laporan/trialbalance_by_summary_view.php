...
<tr style="height:25px">
    ...
    <td align="right">&nbsp; <b><?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_assets_tidak_lancar, 0));?></b></td>
</tr>
<tr>
    <td style="height:35px">&nbsp;</td>
    <td style="font-weight:bold;font-size:13px" >&nbsp;&nbsp; TOTAL ASET</td>
...
<tr style="height:25px">
    ...
    <td align="right">&nbsp; <b><?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_kewajiban_tidak_lancar, 0));?></b></td>
</tr>
<tr>
    <td style="height:35px">&nbsp;</td>
    <td style="font-weight:bold;font-size:13px" >&nbsp;&nbsp; TOTAL KEWAJIBAN</td>
    <td align="right" style="font-size:13px">&nbsp;
        <b>
        <i>
        <?php 
...
<tr>
    <td style="height:35px">&nbsp;</td>
    <td style="font-weight:bold;font-size:13px" >&nbsp;&nbsp; TOTAL EKUITAS</td>
    <td align="right" style="font-size:13px">&nbsp;
        <b>
            <i>
        <?php 
...
<tr>
    <td style="height:35px">&nbsp;</td>
    <td style="font-weight:bold;font-size:13px" >&nbsp;&nbsp; TOTAL PENDAPATAN</td>
    <td align="right" style="font-size:13px">&nbsp;
        <b>
        <i>
        <?php 
...
<tr>
    ...
    <td style="font-weight:bold;font-size:13px" >&nbsp;&nbsp; TOTAL BIAYA</td>
    <td align='right' style='font-size:13px'>&nbsp;
        <b>
            <i>
    <?php 
...
<tr style="height:35px">
    <td>&nbsp;</td>
    <td style="font-size:13px">&nbsp;<b>TOTAL PENDAPATAN LAINNYA</b></td>
    <td align="right" style="font-size:13px">&nbsp; <b><i><?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_pendapatan_lainnya, 0));?></i></b></td>
</tr>
<!-- PENDAPATAN LAINNYA -->
...
<tr style="height:35px">
    <td>&nbsp;</td>
    <td style="font-size:13px">&nbsp;<b>TOTAL BIAYA LAINNYA</b></td>
    <td align="right" style="font-size:13px">&nbsp; <b><i><?php echo preg_replace('/\-([0-9,.]+)/', '(\1)', number_format($tot_biaya_lainnya, 0));?></i></b></td>
</tr>
<!-- BIAYA LAINNYA -->

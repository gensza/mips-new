...
<!-- var_dump($subtotal_biaya_lainnya_balance);-->
<!--exit;-->
...
<td style="background:#f1f1f1;text-align: right;font-weight:bold">&nbsp;
				<?php
				echo preg_replace('/\-([0-9,.]+)/', '(\1)',number_format($subtotal_pendapatan_lainnya_balance,0));
				?></td>
</tr>
<!-- PENDAPATAN LAINNYA -->
...
<td style="background:#f1f1f1;text-align: right;font-weight:bold">&nbsp;
					<?php
					echo preg_replace('/\-([0-9,.]+)/', '(\1)',number_format($subtotal_pendapatan_balance,0));
					?>
				</td>
</tr>
<!-- PENDAPATAN -->

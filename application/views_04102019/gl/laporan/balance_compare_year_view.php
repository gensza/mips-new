...
<table width="70%" border="1" class="font-style">
    <tr>
        <td align="left" style="font-style: italic;width: 80%">
            <table border="1" width="100%" class="font-style" >
<tbody>
<tr>
    <td style="border:none;font-weight:bold;height: 30px;font-size:14px;">&nbsp;
         <!-- Revenue -->
    </td>
    <td>&nbsp;&nbsp; s/d <?php echo $nama_bln.', '.$thn;?>, <span style="font-weight:bold;font-size:16px">TAHUN : <?php echo $thn;?></span></td>
</tr>
<!-- START PENDAPATAN -->    
<tr>
...
<tr>
    ...
    echo number_format($tot_ekuitas+$ok,0);?></td>
        ...
        <td align="right" style="font-style: italic;" valign="top">
             
        <!-- START - BATAS TAHUN COMPARE -->  
        <?php 
            $this->load->view('gl/laporan/balance_compare_tahun_sebelumnya_view');
        ?>
        <!-- END - BATAS TAHUN COMPARE -->

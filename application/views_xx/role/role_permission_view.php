                    ...
                    <ul class="list-group">
                        ...
                        foreach($modules as $a){
                            if($a['have_child'] == 'Y' && $a['position'] == '1'){
                                ...
                                echo '<a href="javascript:void(0)" class="list-group-item list-group-item-info" style="background:#273746;color:white">'.$a[name].' <input title="toggle all" type="checkbox" value="'.$a['id_modules'].'" class="all pull-right" '.$checked_1.' name="cbx_module[]"></a>';
                                
                                // <--- End Headmenu --->
                                
                                    // <--- Start Submenu --->
                                    foreach($modules as $c){
                                        if($c['have_child'] == 'Y' && $c['position'] == '2' && $c['parent'] == $a['id']){
                                            ...
                                            echo '<a href="javascript:void(0)" class="list-group-item list-group-item-default" style="background:#d2b4de">'.$c['name'].' <input title="toggle all" type="checkbox" class="all pull-right" value="'.$c['id_modules'].'" '.$checked_2.' name="cbx_module[]"></a>';


                                            // <--- Start Submenu Sub --->
                                            foreach($modules as $xx){
                                                ...
                                                if($xx['have_child'] == 'N' && $xx['position'] == '3' && $xx['parent'] == $c['id']){

                                                     echo '<a href="javascript:void(0)" class="list-group-item list-group-item-default" style="background:#82fdd2">'.$xx['name'].' <input title="toggle all" type="checkbox" class="all pull-right" value="'.$xx['id_modules'].'" '.$checked_3.' name="cbx_module[]"></a>';
                                                }
                                            }
                                            // <--- Start Submenu Sub --->
                                        ...
                                        }else if($c['have_child'] == 'N' && $c['position'] == '2' && $c['parent'] == $a['id']){

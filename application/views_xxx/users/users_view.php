    ...
    $("#btn_simpan").click(function(){
        ...
        function(){
            ...
            $.ajax({
                ...
                type      : "post",
                dataType  : 'json',
                data      : {lokasi:$("#lokasi").val(), pt : $("#pt").val(),nama : $("#nama").val(),username : $("#username").val(),email : $("#email").val(),role : $("#role").val(),password : $("#pass_word").val(), <?php echo $this->security->get_csrf_token_name(); ?>:'<?php echo $this->security->get_csrf_hash(); ?>'},

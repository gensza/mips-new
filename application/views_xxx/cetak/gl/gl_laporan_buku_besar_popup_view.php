  ...
  */
    ...
    echo "<tr style='border-bottom:1pt solid black;border-top:1pt solid black;'>
        ...
        <tr>
            ...
            <th align='right'>".$begining_balance_d."</th>
            <th align='right'>".$begining_balance_c."</th>
        </tr>";
    ...
    ?>
      ...
      <td align="right" width="10%"><?php echo number_format($a['DEBET_F2'], 2);?></td>
      <td align="right" width="10%"><?php
            if($a['CREDIT_F2'] > 0){
                ...
                echo ''.number_format($a['CREDIT_F2'], 2).'';
            }
      ;?></td>
      </tr>
    ...
    ?>
      ...
      <td align="right" width="150px" style="background: <?php echo $bg_color;?>;color: black;border-bottom: 1px solid white;"><?php echo number_format($ttldr, 2, ".", ",");?></td> <!-- $total_debit-->
      ...
      <td align="right" width="150px" style=";color: black;"><?php echo number_format($curbal_d, 2, ".", ",");?></td>
      <td align="right" width="150px" style=";color: black;">

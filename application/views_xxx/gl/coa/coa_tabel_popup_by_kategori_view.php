...
$(document).ready(function(){
    ...
    $('#tabel_gl_coa').DataTable({ 
        ...
        "ajax": {
            url     : base_url + 'gl/gl_mastercode_by_kategori_popup',
            type    :'POST',
            data    :{<?php echo $this->security->get_csrf_token_name(); ?>:'<?php echo $this->security->get_csrf_hash(); ?>',code_filter:code_filter,kategori:kategori},
            dataType: "json",
            beforeSend: function () {
                //loadingPannel.show();
            },
